...
contract Helper {
	...
	function strConcat(string memory _a, string memory _b, string memory _c, string memory _d) public returns (string memory) {
		return strConcat(_a, _b, _c, _d, "");
	}

	function strConcat(string memory _a, string memory _b, string memory _c) public returns (string memory) {
